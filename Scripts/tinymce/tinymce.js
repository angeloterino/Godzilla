...
!function(e, t) {
    ...
    r(f, [u, d], function(e, t) {
        ...
        function s() {
            ...
            t.fire = function(n, r, i) {
                ...
                while (n && !i.isPropagationStopped());return t
            }
            ,
            t.clean = function(e) {
                var n, r, i = t.unbind;
                        ...
                        t = t.replace(/\\[\"\';:\uFEFF]/g, f).replace(/\"[^\"]+\"|\'[^\']+\'/g, function(e) {
                            ...
                            v && y.length > 0) {
                                if (!e.allow_script_urls && ("behavior" == v || /expression\s*\(|\/\*|\*\//.test(y)))
                                    continue;"font-weight" === v && "700" === y ? y = "bold" : "color" !== v && "background-color" !== v || (y = y.toLowerCase()),
                                y = y.replace(r, n),
                                y = y.replace(i, p),
                                m[v] = b ? h(y, !0) : y
                            }
                    ...
                    do {
                        ...
                        1 === a) {
                            if (e.getAttribute("data-mce-bogus"))
                                continue;if (l = e.nodeName.toLowerCase(),
                            t && t[l]) {
                                if ("br" === l) {
                                    c++;
                                    continue
    ...
    r(k, [_, S], function(e, t) {
        function n(e) {
            return p(e) && (e = e.parentNode),
            h(e) && e.hasAttribute("data-mce-caret")
        }
        function r(e) {
        ...
        function u(e) {
            if (h(e) && i(e) && ("&nbsp;" != e.innerHTML ? e.removeAttribute("data-mce-caret") : o(e)),
            p(e)) {
                var n = t.trim(a(e));
                s(e, n)
            }
    ...
    r(D, [B, C, m], function(e, t, n) {
        ...
        function i(i, a) {
            ...
            l.parse = function(e) {
                ...
                H = a.getSpecialElements(); c = P.exec(e); ) {
                ...
                v = new n({
                    ...
                    start: function(e, t, n) {
                        ...
                        if (r = k ? l.getElementRule(t) : {}) {
                            ...
                            if (B && P[t] && (B = !1),
                            (r.removeEmpty || r.paddEmpty) && b.isEmpty(H))
                                if (r.paddEmpty)
        ...
        return function(s) {
            ...
            function z(e, t) {
                ...
                t.block && (Q ? r == Y.getRoot() && (t.list_block && B(e, t.list_block) || ue(de(e.childNodes), function(e) {
                    G(Q, e.nodeName.toLowerCase()) ? i ? i.appendChild(e) : (i = O(e, Q),
            ...
            function o(o) {
                ...
                function C(e) {
                    ...
                    l.keep_styles !== !1)
                        do
                            if (s[t.nodeName]) {
                                if ("_mce_caret" == t.id)
                                    continue;i = t.cloneNode(!1),
                                a.setAttrib(i, "id", ""),
                                n.hasChildNodes() ? (i.appendChild(n.firstChild),
                                n.appendChild(i)) : (o = i,
                                n.appendChild(i))
                            }
                        while ((t = t.parentNode) && t != B);return r || (o.innerHTML = '<br data-mce-bogus="1">'),
                    n
                }
                function x(t) {
                    var n, r, i;
                ...
                function N() {
                    ...
                    if (F != i.getBody()) {
                        ...
                        H = W ? C(W) : a.create("BR"),
                        e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, F) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()),
                        H.appendChild(a.doc.createTextNode(" ")),
                        H.appendChild(F)) : F.parentNode.insertBefore(H, F) : e() ? (a.insertAfter(H, t()),
                        m(H)) : (F = t(),
                        A = R.cloneRange(),
                        A.setStartAfter(M),
                        A.setEndAfter(F),
                        I = A.extractContents(),
                        "LI" == W && "LI" == I.firstChild.nodeName ? (H = I.firstChild,
                ...
                function T() {
                    H = /^(H[1-6]|PRE|FIGURE)$/.test(z) && "HGROUP" != U ? C(W) : C(),
                    l.end_container_on_empty_block && h(F) && a.isEmpty(M) ? H = a.split(F, M) : a.insertAfter(H, M),
                    v(H)
                }
                ...
                !o.isDefaultPrevented()) {
                    ...
                    B = S(D)) {
                        ...
                        if ("PRE" == z && l.br_in_pre !== !1) {
                            if (!O)
                                return void E()
                        } else if (!W && !O && "LI" != z || W && O)
                            return void E();
                        W && M === i.getBody() || (W = W || "P",
                        x() ? T() : x(!0) ? (H = M.parentNode.insertBefore(C(), M),
                        m(H),
                        v(M)) : (A = R.cloneRange(),
                        A.setEndAfter(M),
                        I = A.extractContents(),
            ...
            return function(i) {
                if (m(i)) {
                    ...
                    if (l(o)) {
                        ...
                        e.screenX = i.screenX,
                        e.screenY = i.screenY,
                        e.maxX = (r.inline ? u.scrollWidth : f.offsetWidth) - 2,
                        e.maxY = (r.inline ? u.scrollHeight : f.offsetHeight) - 2,
                        e.relX = i.pageX - c.x,
                        e.relY = i.pageY - c.y,
          ...
          , b = function(e, t) {
            ...
            return function(r) {
                ...
                if (e.dragging) {
                    ...
                    f(e.ghost, t.getBody()),
                    h(e.ghost, s, e.width, e.height, e.maxX, e.maxY),
    ...
    r(Ze, [d, ne, $, k, te, Ye, Ke, Ge, _, T, W, I, z, p, u, Qe, S], function(e, t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g) {
        ...
        function y(c) {
            ...
            function A(e, t, n) {
                ...
                r.isDefaultPrevented() ? null : (R(t, -1 === e),
                se.show(n, t))
            }
            function B(e) {
                var t;
            ...
            function O(e, t, n, r) {
                ...
                x(i)) ? A(e, i, -1 == e) : (s = P(r),
                o = M(e, r),
                n(o) ? B(o.getNode(-1 == e)) : (o = t(o)) ? n(o) ? A(e, o.getNode(-1 == e), 1 == e) : (a = t(o),
                n(a) && L(o, a) ? A(e, a.getNode(-1 == e), 1 == e) : s ? $(o.toRange()) : null ) : s ? r : null )
            }
            function H(e, t, n) {
            ...
            function V(e) {
                ...
                x(t.getNode()) ? A(1, t.getNode(), !t.isAtEnd()) : x(t.getNode(!0)) ? A(1, t.getNode(!0), !1) : (r = c.dom.getParent(t.getNode(), f.or(x, C)),
                x(r) ? A(1, r, !1) : (se.hide(),
                null ))
            }
            function $(e) {
            ...
            function K(e, t, n, i) {
                ...
                x(o)) ? $(q(o)) : (a = M(e, i),
                n(a) && r.isCaretContainerBlock(i.startContainer) ? (l = -1 == e ? ie.prev(a) : ie.next(a),
                l ? $(l.toRange()) : i) : t(a) ? $(q(a.getNode(-1 == e))) : (s = -1 == e ? ie.prev(a) : ie.next(a),
                t(s) ? -1 === e ? X(e, a, s) : X(e, s, a) : void 0))
            }
            function G() {
                function r(e, t) {
                    var n = t(T());
                ...
                c.on("mousedown", function(e) {
                    ...
                    if (t = i(e.target))
                        ...
                        Z(B(t))) : (ee(),
                        o(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY));
                    else {
                        ee(),
                        se.hide();
                        var n = s.closestCaret(re, e.clientX, e.clientY);
                        n && (H(e.target, n.node) || (e.preventDefault(),
                        c.getBody().focus(),
            ...
            function J() {
                var e = c.contentStyles
                  , t = ".mce-content-body";
                e.push(se.getCss()),
                e.push(t + " .mce-offscreen-selection {position: absolute;left: -9999999999px;}" + t + " *[contentEditable=false] {cursor: default;}" + t + " *[contentEditable=true] {cursor: text;}")
            }
            function Q(e) {
            ...
            function ee() {
                ce && (ce.removeAttribute("data-mce-selected"),
                c.$("#" + le).remove(),
                ce = null )
            }
            function te() {
    ...
    r(tt, [w, g, E, R, A, O, P, Y, J, Q, Z, ee, oe, ae, N, f, Ae, Pe, B, L, He, d, m, u, Ie, Fe, ze, je, Ze, et], function(e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, N, E, _, S, k, T, R, A) {
        ...
        return B.prototype = {
            render: function() {
                ...
                function t() {
                    ...
                    r.theme && "function" != typeof r.theme && "-" != r.theme.charAt(0) && !L.urls[r.theme]) {
                        var t = r.theme_url;
                        t = t ? n.documentBaseURI.toAbsolute(t) : "themes/" + r.theme + "/theme" + o + ".min.js",
                        L.load(r.theme, t)
                    }
                    N.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")),
                    O(r.external_plugins, function(e, t) {
                        M.load(t, e),
                        r.plugins += " " + t
                    }),
            ...
            init: function() {
                ...
                n.content_css && O(H(n.content_css), function(e) {
            ...
            initContentBody: function(t) {
                    ...
                    for (var r = e.length, i, o = n.dom, a, s; r--; )
                        ...
                        !i.attributes.map[s]) {
                            if (0 === a.indexOf("data:") || 0 === a.indexOf("blob:"))
                                continue;"style" === t ? (a = o.serializeStyle(o.parseStyle(a), i.name),
                            a.length || (a = null ),
                            i.attr(s, a),
                ...
                O(n.contentStyles, function(e) {
                    m += e + "\r\n"
                }),
                n.dom.addStyle(m)),
                O(n.contentCSS, function(e) {
            ...
            getParam: function(e, t, n) {
                ...
                return "hash" === n ? (i = {},
                "string" == typeof r ? O(r.indexOf("=") > 0 ? r.split(/[;,](?![^=;,]*(?:[;,]|$))/) : r.split(","), function(e) {
                    e = e.split("="),
            ...
            save: function(e) {
                ...
                if (n && t.initialized)
                    ...
                    (i = D.getParent(t.id, "form")) && O(i.elements, function(e) {
            ...
            addVisual: function(e) {
                ...
                O(i.select("table,a", e), function(e) {
                    var t;
                    switch (e.nodeName) {
                    case "TABLE":
            ...
            recalc: function(e) {
                ...
                !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    ...
                    n = r.length; n > t; t++)
                        ...
                        p = h.layoutRect(),
                        y = p.maxFlexSize || p[_],
                        "center" === s ? x[D] = Math.round(i[L] / 2 - p[M] / 2) : "stretch" === s ? (x[M] = z(p[P] || 0, i[L] - o[O] - o[H]),
                        x[D] = o[O]) : "end" === s && (x[D] = i[L] - p[M] - o.top),
                        p.flex > 0 && (y += p.flex * C),
                        x[E] = y,
                        x[S] = w,
                        h.layoutRect(x),
